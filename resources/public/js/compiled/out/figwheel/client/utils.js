...
var or__27304__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34214 = {"detail":data};
return obj34214;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27292__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27292__auto__)){
var and__27292__auto____$1 = (window["CustomEvent"]);
...
var args34219 = [];
var len__28417__auto___34225 = arguments.length;
var i__28418__auto___34226 = (0);
while(true){
if((i__28418__auto___34226 < len__28417__auto___34225)){
args34219.push((arguments[i__28418__auto___34226]));

var G__34227 = (i__28418__auto___34226 + (1));
i__28418__auto___34226 = G__34227;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args34219.length)].join('')));
...
var f = (function (){var pred__34222 = cljs.core._EQ_;
var expr__34223 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34222.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34223))){
return ((function (pred__34222,expr__34223){
return (function (p1__34215_SHARP_){
return console.warn(p1__34215_SHARP_);
});
;})(pred__34222,expr__34223))
} else {
if(cljs.core.truth_(pred__34222.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34223))){
return ((function (pred__34222,expr__34223){
return (function (p1__34216_SHARP_){
return console.debug(p1__34216_SHARP_);
});
;})(pred__34222,expr__34223))
} else {
if(cljs.core.truth_(pred__34222.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34223))){
return ((function (pred__34222,expr__34223){
return (function (p1__34217_SHARP_){
return console.error(p1__34217_SHARP_);
});
;})(pred__34222,expr__34223))
} else {
return ((function (pred__34222,expr__34223){
return (function (p1__34218_SHARP_){
return console.log(p1__34218_SHARP_);
});
;})(pred__34222,expr__34223))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34229){
...
var opts = map__34232__$1;
var eval_fn = cljs.core.get.call(null,map__34232__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34234_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34236,(0),null);
var v = cljs.core.nth.call(null,vec__34236,(1),null);
...
var args34239 = [];
var len__28417__auto___34242 = arguments.length;
var i__28418__auto___34243 = (0);
while(true){
if((i__28418__auto___34243 < len__28417__auto___34242)){
args34239.push((arguments[i__28418__auto___34243]));

var G__34244 = (i__28418__auto___34243 + (1));
i__28418__auto___34243 = G__34244;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__27292__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1497988469761
...
var vec__39266_39269 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_39270 = cljs.core.nth.call(null,vec__39266_39269,(0),null);
var only_after_39271 = cljs.core.nth.call(null,vec__39266_39269,(1),null);
var db_changed_QMARK__39272 = (!((only_before_39270 == null))) || (!((only_after_39271 == null)));
if(db_changed_QMARK__39272){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_39270);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_39271);
...
var map__39279 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__39279__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__39279__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__39287 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__39287__$1;
var event = cljs.core.get.call(null,map__39287__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28417__auto___39290 = arguments.length;
var i__28418__auto___39291 = (0);
while(true){
if((i__28418__auto___39291 < len__28417__auto___39290)){
args__28424__auto__.push((arguments[i__28418__auto___39291]));

var G__39292 = (i__28418__auto___39291 + (1));
i__28418__auto___39291 = G__39292;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__28425__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq39289){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39289));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__27304__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__28424__auto__ = [];
var len__28417__auto___39298 = arguments.length;
var i__28418__auto___39299 = (0);
while(true){
if((i__28418__auto___39299 < len__28417__auto___39298)){
args__28424__auto__.push((arguments[i__28418__auto___39299]));

var G__39300 = (i__28418__auto___39299 + (1));
i__28418__auto___39299 = G__39300;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28425__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__39293_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__39294_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__39294_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq39295){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__39296,G__39297,seq39295__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1497988478088
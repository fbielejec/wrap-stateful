...
var len__28417__auto___39748 = arguments.length;
var i__28418__auto___39749 = (0);
while(true){
if((i__28418__auto___39749 < len__28417__auto___39748)){
args__28424__auto__.push((arguments[i__28418__auto___39749]));

var G__39750 = (i__28418__auto___39749 + (1));
i__28418__auto___39749 = G__39750;
continue;
} else {
}
break;
...
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__28425__auto__);
});
...
return cljs.core.not_EQ_.call(null,cljs.core.key.call(null,p1__39742_SHARP_),new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246));
});})(prefs))
...
var k = cljs.core.first.call(null,p1__39743_SHARP_);
...
return cljs.core.not_EQ_.call(null,cljs.core.first.call(null,p1__39744_SHARP_),new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709));
});})(prefs,event))
...
if(cljs.core.truth_(p1__39745_SHARP_.call(null,re_frisk.help.fx))){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__39745_SHARP_,p1__39745_SHARP_.call(null,re_frisk.help.fx)]);
} else {
return p1__39745_SHARP_;
}
});})(prefs,event,sub))
...
if(cljs.core.truth_(p1__39746_SHARP_.call(null,re_frisk.help.cofx))){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([p1__39746_SHARP_,p1__39746_SHARP_.call(null,re_frisk.help.cofx)]);
} else {
...
re_frisk.core.enable_re_frisk_BANG_.cljs$lang$applyTo = (function (seq39747){
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39747));
});

re_frisk.core.enable_frisk_BANG_ = (function re_frisk$core$enable_frisk_BANG_(var_args){
var args__28424__auto__ = [];
var len__28417__auto___39752 = arguments.length;
var i__28418__auto___39753 = (0);
while(true){
if((i__28418__auto___39753 < len__28417__auto___39752)){
args__28424__auto__.push((arguments[i__28418__auto___39753]));

var G__39754 = (i__28418__auto___39753 + (1));
i__28418__auto___39753 = G__39754;
continue;
} else {
}
break;
...
var argseq__28425__auto__ = ((((0) < args__28424__auto__.length))?(new cljs.core.IndexedSeq(args__28424__auto__.slice((0)),(0),null)):null);
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__28425__auto__);
});
...
re_frisk.core.enable_frisk_BANG_.cljs$lang$applyTo = (function (seq39751){
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39751));
});
...
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"views","views",1450155487),view,new cljs.core.Keyword(null,"subs","subs",-186681991)], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__39755_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([p1__39755_SHARP_],[re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__39755_SHARP_], null))]);
}),subs)));

var seq__39760 = cljs.core.seq.call(null,subs);
var chunk__39761 = null;
var count__39762 = (0);
var i__39763 = (0);
while(true){
if((i__39763 < count__39762)){
var s = cljs.core._nth.call(null,chunk__39761,i__39763);
...
var G__39764 = seq__39760;
var G__39765 = chunk__39761;
var G__39766 = count__39762;
var G__39767 = (i__39763 + (1));
seq__39760 = G__39764;
chunk__39761 = G__39765;
count__39762 = G__39766;
i__39763 = G__39767;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__39760);
if(temp__4657__auto__){
var seq__39760__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__39760__$1)){
var c__28123__auto__ = cljs.core.chunk_first.call(null,seq__39760__$1);
var G__39768 = cljs.core.chunk_rest.call(null,seq__39760__$1);
var G__39769 = c__28123__auto__;
var G__39770 = cljs.core.count.call(null,c__28123__auto__);
var G__39771 = (0);
seq__39760 = G__39768;
chunk__39761 = G__39769;
count__39762 = G__39770;
i__39763 = G__39771;
continue;
} else {
var s = cljs.core.first.call(null,seq__39760__$1);
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"subs","subs",-186681991),s], null),re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null)));

var G__39772 = cljs.core.next.call(null,seq__39760__$1);
var G__39773 = null;
var G__39774 = (0);
var G__39775 = (0);
seq__39760 = G__39772;
chunk__39761 = G__39773;
count__39762 = G__39774;
i__39763 = G__39775;
continue;
}
} else {
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246),(function (db,p__39776){
var vec__39777 = p__39776;
var _ = cljs.core.nth.call(null,vec__39777,(0),null);
var value = cljs.core.nth.call(null,vec__39777,(1),null);
return value;
}));

//# sourceMappingURL=core.js.map?rel=1497988478927
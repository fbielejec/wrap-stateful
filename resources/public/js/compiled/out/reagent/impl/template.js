...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27915__auto__,writer__27916__auto__,opt__27917__auto__){
return cljs.core._write.call(null,writer__27916__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__38355 = o;
(G__38355[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38356__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38356 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38357__i = 0, G__38357__a = new Array(arguments.length -  0);
while (G__38357__i < G__38357__a.length) {G__38357__a[G__38357__i] = arguments[G__38357__i + 0]; ++G__38357__i;}
  args = new cljs.core.IndexedSeq(G__38357__a,0,null);
} 
return G__38356__delegate.call(this,args);};
G__38356.cljs$lang$maxFixedArity = 0;
G__38356.cljs$lang$applyTo = (function (arglist__38358){
var args = cljs.core.seq(arglist__38358);
return G__38356__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__27292__auto__ = !((jsprops == null));
if(and__27292__auto__){
var and__27292__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__38363 = jsprops;
(G__38363["defaultValue"] = value);

(G__38363["onChange"] = ((function (G__38363,v,value,on_change){
return (function (p1__38361_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38361_SHARP_);
});})(G__38363,v,value,on_change))
);
...
var vec__38370 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38370,(0),null);
var id = cljs.core.nth.call(null,vec__38370,(1),null);
var class$ = cljs.core.nth.call(null,vec__38370,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38375 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38375 == null)){
} else {
var key_38376 = temp__4661__auto___38375;
(jsprops["key"] = key_38376);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38378 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38378["name"] = c);
...
var len__28417__auto___38384 = arguments.length;
var i__28418__auto___38385 = (0);
while(true){
if((i__28418__auto___38385 < len__28417__auto___38384)){
args__28424__auto__.push((arguments[i__28418__auto___38385]));

var G__38386 = (i__28418__auto___38385 + (1));
i__28418__auto___38385 = G__38386;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28425__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38382){
var G__38383 = cljs.core.first.call(null,seq38382);
var seq38382__$1 = cljs.core.next.call(null,seq38382);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38383,seq38382__$1);
});
...
break;
default:
var G__38390 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38390;
continue;
...
var n__28227__auto___38393 = a.length;
var i_38394 = (0);
while(true){
if((i_38394 < n__28227__auto___38393)){
(a[i_38394] = reagent.impl.template.as_element.call(null,(a[i_38394])));
...
var a = cljs.core.into_array.call(null,s);
var n__28227__auto___38396 = a.length;
var i_38397 = (0);
while(true){
if((i_38397 < n__28227__auto___38396)){
var val_38398 = (a[i_38397]);
if((cljs.core.vector_QMARK_.call(null,val_38398)) && ((reagent.impl.template.key_from_vec.call(null,val_38398) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38397] = reagent.impl.template.as_element.call(null,val_38398));

var G__38399 = (i_38397 + (1));
i_38397 = G__38399;
continue;
} else {
}
...
var ctx = ({});
var vec__38403 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38403,(0),null);
var derefed = cljs.core.nth.call(null,vec__38403,(1),null);
...
var G__38407 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38407) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38407){
...
//# sourceMappingURL=template.js.map?rel=1497988475885